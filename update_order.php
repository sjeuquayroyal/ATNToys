...
<html lang="en">
  <head>
	...
	include_once('connection.php');
        if(isset($_GET["id"])){
			$id=$_GET["id"];
			$result=pg_query($conn,"select*from `order` where orderid='$id'") or die(pg_error($conn)) ;
  ...
  <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      <div class="position-sticky pt-3">
        <ul class="nav flex-column">
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="admin_order.html">
          ...
          <li class="nav-item">
            <a class="nav-link" href="admin_customer.html">
