...
<div class="container-fluid">
  ...
  <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <h2>Customer</h2>
      <div class="add"><a href="add_customer.php"><i class="fas fa-plus"></i>&nbsp;Add Customer</a></div>
        ...
        <table class="table table-striped table-sm">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><a  href="update_customer.php?function=del&&id=<?php echo $row["customerid"];?>"><i class="fas fa-pencil-alt"></i></a></td>
