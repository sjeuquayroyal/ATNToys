    ...
    <?php
            ...
            if(isset($_GET["function"])=="del"){
                if(isset($_GET["id"])){
                    ...
                    pg_query($conn,"delete from orderdetail where productid='$id'");
...
<div class="container-fluid">
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <h2>Products</h2>
      <div class="add"><a href="add_product.php"><i class="fas fa-plus"></i>&nbsp;Add Products</a></div>
      <div class="table-responsive">
        <table class="table table-striped table-sm">
          ...
          <?php
			$No=1;
            $result=pg_query($conn,"Select productid, Img, ProductName, Price from product");
            ...
            <tr>
              ...
              <td><a href="update_product.php?function=del&&id=<?php echo $row["productid"];?>"><i class="fas fa-pencil-alt"></i></a></td>
